...
<div class="container-fluid px-0">
    <div class="row align-items-center mb-4">
        <div class="col-12">
            ...
            <p class="mb-0" style="color: var(--text-light); font-size: 13.5px;">Selamat datang di modul Manajemen User. Halaman ini merupakan bagian dari sistem ERP BonOps.</p>
        </div>
    </div>
    ...
    <div class="card rounded-4 p-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h5 class="fw-bold mb-1" style="color: var(--text-heading);">Konten Modul Manajemen User</h5>
