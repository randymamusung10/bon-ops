<x-modal id="showBranchModal" title="Detail Cabang" description="Informasi lengkap mengenai cabang ini." size="lg">
    ...
    <div class="d-flex align-items-center mb-4 p-3 rounded-4" style="background: rgba(14, 165, 233, 0.05); border: 1px solid rgba(14, 165, 233, 0.1);">
        ...
        <div class="ms-3">
            <h5 class="mb-1 fw-bold" style="color: var(--text-heading);">{{ $branch->name }}</h5>
            <div class="d-flex align-items-center gap-2">
                <span class="badge bg-secondary-subtle text-secondary px-2 py-1"><i class="bi bi-upc-scan me-1"></i>{{ $branch->code }}</span>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="p-3 rounded-3 h-100" style="background: var(--bg-dark-secondary); border: 1px solid var(--border-color);">
                <div class="text-muted mb-1" style="font-size: 13px; font-weight: 500; letter-spacing: 0.2px;">
                    <i class="bi bi-building me-1"></i> Kota / Wilayah
                </div>
                <div class="fw-medium text-heading" style="font-size: 14px;">
                    {{ $branch->city ?: 'Tidak ada data kota' }}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="p-3 rounded-3 h-100" style="background: var(--bg-dark-secondary); border: 1px solid var(--border-color);">
                <div class="text-muted mb-1" style="font-size: 13px; font-weight: 500; letter-spacing: 0.2px;">
                    <i class="bi bi-calendar-event me-1"></i> Tanggal Didaftarkan
                </div>
                <div class="fw-medium text-heading" style="font-size: 14px;">
