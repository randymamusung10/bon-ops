<x-modal id="addAdjustmentModal" title="Buat Penyesuaian Stok" description="Masukkan detail penyesuaian stok atau stok opname." size="xl">
    <form id="add-adjustment-form">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12">
                ...
                <x-form.textarea name="notes" id="add-notes" rows="2" placeholder="Alasan penyesuaian (opsional)"></x-form.textarea>
