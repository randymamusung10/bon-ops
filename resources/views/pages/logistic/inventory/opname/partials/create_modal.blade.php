<x-modal id="addOpnameModal" title="Buat Stock Opname" description="Masukkan detail stok opname produk secara berkala." size="xl">
    <form id="add-opname-form">
        @csrf
        <div class="row g-3 mb-4">
            ...
            <div class="col-12">
                ...
                <x-form.textarea name="notes" id="add-notes" rows="2" placeholder="Catatan opsional mengenai stock opname ini"></x-form.textarea>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 mt-2 gap-2">
            ...
            <x-button type="button" variant="light-primary" size="sm" id="btn-load-system-stock" icon="bi-arrow-repeat">
                Muat Stok Sistem
            </x-button>
        </div>
