<x-modal id="createModal" title="Buat Penerimaan Kas Baru" size="xl">
    <form id="form-create-receipt" enctype="multipart/form-data">
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-4">
                ...
                <x-form.input type="text" name="reference_number" placeholder="Contoh: INV-001 / Struk Beli" />
            ...
            <table class="table align-middle mb-0" id="items-table" style="font-size: 13px; --bs-table-bg: transparent; --bs-table-border-color: rgba(226, 232, 240, 0.2);">
                ...
                <tbody class="border-top-0">
                    <tr>
                        ...
                        <td class="py-2"><x-form.input size="sm" type="text" name="items[0][description]" placeholder="Contoh: Pendapatan Bunga, Modal Awal..." required /></td>
        ...
        <div class="d-flex justify-content-end gap-2 pt-3 border-top" style="border-color: rgba(226, 232, 240, 0.2) !important;">
            ...
            <x-button type="button" variant="primary" size="sm" id="btn-save-receipt" icon="bi-check2">Simpan Draft</x-button>
        </div>
    </form>
</x-modal>
...
$(document).ready(function() {
    ...
    $('#btn-save-receipt').on('click', function() {
        ...
        $.ajax({
            url: "{{ route('business.finance.cash_receipt.store') }}",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
