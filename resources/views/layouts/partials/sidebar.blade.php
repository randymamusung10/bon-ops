            ...
            <div>
                ...
                <div class="collapse submenu-list-wrapper {{ Request::is('business/finance*') ? 'show' : '' }}" id="financeMenu">
                    <div class="submenu-list">
                        ...
                        <a href="{{ route('business.finance.cash_receipt.index') }}" class="submenu-link {{ Route::is('business.finance.cash_receipt.*') ? 'active' : '' }}"><i class="bi bi-box-arrow-in-right"></i><span>Penerimaan Kas</span></a>
                        <a href="{{ route('business.finance.cash_disbursement.index') }}" class="submenu-link {{ Route::is('business.finance.cash_disbursement.*') ? 'active' : '' }}"><i class="bi bi-box-arrow-right"></i><span>Pengeluaran Kas</span></a>
            ...
            <div>
                ...
                <div class="collapse submenu-list-wrapper {{ Request::is('business/reports*') ? 'show' : '' }}" id="reportsMenu">
                    <div class="submenu-list">
                        ...
                        <a href="{{ route('business.reports.sales_itemized') }}" class="submenu-link {{ Route::is('business.reports.sales_itemized') ? 'active' : '' }}"><i class="bi bi-list-columns-reverse"></i><span>Penjualan per Produk</span></a>
                        ...
                        <a href="{{ route('business.reports.purchase_itemized') }}" class="submenu-link {{ Route::is('business.reports.purchase_itemized') ? 'active' : '' }}"><i class="bi bi-cart-plus"></i><span>Pembelian per Produk</span></a>
