...
class ProfitLossController extends Controller
{
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('pages.business.finance.profit_loss.pdf', compact(
            'startDate', 'endDate', 
            'revenues', 'cogs', 'expenses', 
            'totalRevenue', 'totalCogs', 'totalExpense', 
            'grossProfit', 'netProfit'
        ...
        return $pdf->download('Laba_Rugi_' . Carbon::parse($startDate)->format('Ymd') . '_' . Carbon::parse($endDate)->format('Ymd') . '.pdf');
    }
}
