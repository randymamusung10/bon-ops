...
class CashDisbursementController extends Controller
{
    ...
    {
        return view('pages.business.finance.cash-disbursement.index');
    }

    public function data()
    {
        $tenantId = Auth::user()->tenant_id ?? 1;
        $query = $this->repository->datatable($tenantId, 'disbursement');
    ...
    public function create()
    {
        ...
        return view('pages.business.finance.cash-disbursement.partials.create_modal', compact('cashAccounts', 'otherAccounts'));
    }
    ...
    public function store(CashTransactionRequest $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Pengeluaran Kas berhasil disimpan sebagai Draft.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function edit($uuid)
    {
        ...
        if ($transaction->status !== 'draft') {
            return response()->json(['message' => 'Hanya Pengeluaran Kas Draft yang dapat diedit.'], 403);
        }
        ...
        return view('pages.business.finance.cash-disbursement.partials.edit_modal', compact('transaction', 'cashAccounts', 'otherAccounts'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('pages.business.finance.cash-disbursement.partials.show_modal', compact('transaction'));
    }
    ...
    public function destroy($uuid)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Draft Pengeluaran Kas berhasil dihapus.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function submit($uuid)
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Pengeluaran Kas berhasil diajukan.']);
        } catch (\Exception $e) {
    ...
    public function approve($uuid)
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Pengeluaran Kas berhasil disetujui.']);
        } catch (\Exception $e) {
            return response()->json(['success' => false, 'message' => $e->getMessage()], 422);
        }
    }
    ...
    public function post($uuid)
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Pengeluaran Kas berhasil diposting. Buku besar telah terupdate.']);
        } catch (\Exception $e) {
            return response()->json(['success' => false, 'message' => $e->getMessage()], 422);
        }
    }
